...
Where r is duplication ratio, d is distance to the datas target point, s is average space in agents in the locality, this is the same as in Section \ref{sec:Simple2}.
